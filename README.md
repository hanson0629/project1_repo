...
![Bitcoin Picture](https://user-images.githubusercontent.com/78338890/115159241-3582c800-a060-11eb-87e4-f9f62854b3e5.jpg)
...
Compared with other traditional assets, bitcoin experiences drastically higher volatility with occasional correlation during specific event driven volatility at certain point during early 2019 and 2020.
...
Bitcoin can be seen as an outlier based on the bubble chart with 5yr avg return as the y-axis and joined volatility as the x-axis. Based on the observation, the major equity indices including S&P 500, NASDAQ, and Dow Jones are considered relatively stable placing them in the bottom left corner in terms of returns and volatility. Crude is relatively volatile with a sharp drop during March 2020 that primarily affected the volatility. Given what was examined, Bitcoin knocks them out of the park with all three variables considered (return, volatility, volume).
